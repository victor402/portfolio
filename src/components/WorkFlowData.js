import pro1 from "../pics/SlickChef.png";
import prop2 from "../pics/VASC.png";
const projectFlowData = [
  ...
  },
  {
    imgsrc: prop2,
    title: "VASC",
    text: "VASC is an online e-commerce app that has items one can shop from. Items one can shop from varies from building items, school items, home items, electronics and gadgets. Technologies used incliude react,mongoose,mongoDB,node.js,html,css,javascript.",
    view: "https://va-shopping-center.herokuapp.com/",
  },
];

export default projectFlowData;
